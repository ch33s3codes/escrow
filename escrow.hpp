...
CONTRACT escrow : public eosio::contract {
    public:
        ...
        void get_payable(uint64_t dealId){
       ...
       TABLE deal
        {
            ...
            uint64_t threshold;
            time_point_sec timeout_of_funding;
            time_point_sec timeout_of_acceptance;
            vector<uint64_t> payout_schedule;
            time_point_sec payout_term;
    ...
    typedef eosio::multi_index<"deals"_n, deal, 
            ...
            eosio::indexed_by<"contractor"_n, eosio::const_mem_fun<deal, uint64_t, &deal::by_contractor>>> deals_table;
    ...
    typedef eosio::multi_index<"deposits"_n, deposit,
            ...
            eosio::indexed_by<"sponsor"_n, eosio::const_mem_fun<deposit, uint64_t, &deposit::by_sponsor>>> deposits_table;
